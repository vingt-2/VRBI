...
/// Final Color:
                ...
                float4 _node_3432_copy = tex2D(_Grass_Diffuse,TRANSFORM_TEX(i.uv1, _Grass_Diffuse));
                fixed4 finalRGBA = fixed4(finalColor,_node_3432_copy.a);
...
/// Final Color:
                float3 finalColor = diffuse + specular;
                float4 _node_3432_copy = tex2D(_Grass_Diffuse,TRANSFORM_TEX(i.uv1, _Grass_Diffuse));
                fixed4 finalRGBA = fixed4(finalColor * _node_3432_copy.a,0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
